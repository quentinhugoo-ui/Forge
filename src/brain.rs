    ...
    let mut template = BrainGeneralCodeActTemplate {
        ...
        slots: vec![
            BrainCodeActTemplateSlot {
                ...
                default_value: String::new(),
                allowed_values: Vec::new(),
                description: "Short relevant session title used in /rename_session_<short title>_: 2-5 natural words, nominal and specific like Codex or Claude. Do not copy the prompt and do not use only a proper noun.".to_string(),
            },
            BrainCodeActTemplateSlot {
