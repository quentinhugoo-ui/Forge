...
pub const BRAIN_RENAME_SESSION_COMMAND_DESCRIPTION: &str = "Rename the current chat session with a short relevant LLM-authored title after identifying the first user message subject. This updates sidebar recents and Brain archive history; keep the title compact.";
...
pub fn brain_rename_session_codeact_template() -> BrainGeneralCodeActTemplate {
    let mut template = BrainGeneralCodeActTemplate {
        ...
        section: "general".to_string(),
        purpose: "Rename the current session from the LLM's short title for the first user message topic, keeping sidebar recents and Brain archive history aligned.".to_string(),
        ...
        slots: vec![
            BrainCodeActTemplateSlot {
                ...
                default_value: String::new(),
                allowed_values: Vec::new(),
                description: "Short relevant session title, ideally 2-6 words, no quotes needed in the rendered title.".to_string(),
            },
            BrainCodeActTemplateSlot {
