...
const WIDGET_HIT_REGION_TARGETS: ReadonlyArray<{ selector: string; padding: WidgetHitPadding }> = [
  ...
  { selector: ".bottomControls__modelButton", padding: { left: 24, right: 12, top: 7, bottom: 7 } },
  { selector: ".bottomControls__reasoningButton", padding: { left: 12, right: 24, top: 7, bottom: 7 } },
  ...
  { selector: ".widgetTranscriptPanel__topSessionTab", padding: { left: 6, right: 6, top: 8, bottom: 0 } },
  { selector: ".widgetSessionTabs", padding: { left: 6, right: 6, top: 5, bottom: 0 } },
