  ...
  if (fileModification) {
    return (
      <div className={eventClassName}>
        ...
        <span className="transcriptCodeActFileEvent__fileCard" data-tooltip={fileModification.path}>
        ...
        <div className="assistantText__learningActions" aria-label="Learning promotion actions">
          {interrupt.promote.map((action) => (
            <button
              ...
              data-tooltip={`Promote as ${brainLearningPromotionLabel(action)}`}
          ...
          const actions = (
            <div className="transcriptActions">
              <button
                ...
                data-tooltip={copiedId === message.id ? "Copied" : "Copy"}
              ...
              <button
                ...
                aria-pressed={pinned}
                data-tooltip={pinned ? "Unpin chapter" : "Pin chapter"}
    ...
    >
      <div className="composerQuestionnaire__header widgetTranscriptPanel__header">
        ...
        <button
          ...
          data-tooltip="Collapse conversation panel"
          onClick={onReduce}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {assistantStopActive ? (
            <Square className="sendGlyph sendGlyph--stopSquare" size={15} strokeWidth={0} aria-hidden="true" />
          ) : (
      ...
      <nav className="bottomControls" aria-label="Bottom controls">
        ...
        <div className="bottomControls__models">
          ...
          <button
            ...
            data-tooltip="Cycle reasoning effort"
