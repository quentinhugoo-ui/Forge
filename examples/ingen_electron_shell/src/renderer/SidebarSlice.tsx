...
function GmailIcon() {
  return (
    <svg className="sidebarModule__logo" viewBox="0 0 256 193" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function OutlookIcon() {
  return (
    <svg className="sidebarModule__logo" viewBox="2 2 28 28" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function AmazonIcon() {
  return (
    <svg className="sidebarModule__logo" viewBox="0 0 32 32" preserveAspectRatio="xMidYMid meet" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function AirbnbIcon() {
  return (
    <svg className="sidebarModule__logo" viewBox="0 0 256 275" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        fill="#FF385C"
...
function WhatsappIcon() {
  return (
    <svg className="sidebarModule__logo" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        fill="#25D366"
...
function ModulesDrawer({ onModuleSelect }: { onModuleSelect?: (id: SidebarModuleId) => void }) {
                ...
                <Fragment key={tool.id}>
                  ...
                  {hasDrawer ? (
                    ...
                    >
                      ...
                      {tool.id === "modules" ? <ModulesDrawer onModuleSelect={onModuleSelect} /> : null}
                    </div>
                  ) : null}
                </Fragment>
              );
