  ...
  const messages: ChatArchiveMessage[] = [
    {
      ...
      role: "user",
      text: "Retrouve le passage ou on parlait du budget croissant et du four a 180 degres.",
    ...
    },
    {
      ...
      text: [
        ...
        "returned_count=12",
        "truncated=false",
        "token_budget_used_estimate=186",
        "index_snapshot_hash=sha256:demo-index-searcharchive-loop",
        "proof_hash=sha256:demo-searcharchive-loop-proof",
        "hits:",
        "  - rank: 1",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-memory\"",
        "    session_title: \"Patisserie Budget\"",
        ...
        "    evidence_hash: sha256:demo-hit-1",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-memory?turn=demo-memory-assistant-recipe\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-memory?around=demo-memory-assistant-recipe\"",
        "  - rank: 2",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-memory\"",
        "    session_title: \"Patisserie Budget\"",
        ...
        "    evidence_hash: sha256:demo-hit-2",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-memory?turn=demo-memory-user-budget\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-memory?around=demo-memory-user-budget\"",
        "  - rank: 3",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-memory\"",
        "    session_title: \"Patisserie Budget\"",
        "    turn_id: \"demo-memory-user-later\"",
        "    role: user",
        "    created_at: \"2026-06-15T10:18:33.000Z\"",
        "    matched_field: message_text",
        "    score: 9.400",
        "    snippet: \"Plus tard dans la session, verifie que le four reste bien a 180 degres si on double les croissants.\"",
        "    evidence_hash: sha256:demo-hit-3",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-memory?turn=demo-memory-user-later\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-memory?around=demo-memory-user-later\"",
        "  - rank: 4",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-menu-anniversaire\"",
        "    session_title: \"Menu Anniversaire\"",
        "    turn_id: \"demo-menu-assistant-four\"",
        "    role: assistant",
        "    created_at: \"2026-06-12T16:05:09.000Z\"",
        "    matched_field: message_text",
        "    score: 7.800",
        "    snippet: \"Pour le menu anniversaire, les mini croissants passent au four a 180 degres pendant 12 minutes.\"",
        "    evidence_hash: sha256:demo-hit-4",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?turn=demo-menu-assistant-four\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?around=demo-menu-assistant-four\"",
        "  - rank: 5",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-menu-anniversaire\"",
        "    session_title: \"Menu Anniversaire\"",
        "    turn_id: \"demo-menu-user-budget\"",
        "    role: user",
        "    created_at: \"2026-06-12T16:21:44.000Z\"",
        "    matched_field: message_text",
        "    score: 6.900",
        "    snippet: \"Note aussi un budget de 18 euros pour les croissants sales et la plaque de cuisson.\"",
        "    evidence_hash: sha256:demo-hit-5",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?turn=demo-menu-user-budget\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?around=demo-menu-user-budget\"",
        "  - rank: 6",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-notes-cuisson\"",
        "    session_title: \"Notes Cuisson Ete\"",
        "    turn_id: \"demo-notes-assistant-temperature\"",
        "    role: assistant",
        "    created_at: \"2026-06-09T11:12:00.000Z\"",
        "    matched_field: message_text",
        "    score: 5.700",
        "    snippet: \"Quand le four est instable, rester a 180 degres et surveiller les croissants apres 10 minutes.\"",
        "    evidence_hash: sha256:demo-hit-6",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-notes-cuisson?turn=demo-notes-assistant-temperature\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-notes-cuisson?around=demo-notes-assistant-temperature\"",
        "  - rank: 7",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-memory\"",
        "    session_title: \"Patisserie Budget\"",
        "    turn_id: \"demo-memory-assistant-margin\"",
        "    role: assistant",
        "    created_at: \"2026-06-15T10:42:20.000Z\"",
        "    matched_field: message_text",
        "    score: 5.300",
        "    snippet: \"Si le budget croissant depasse 30 euros, reduire la garniture mais garder le four a 180 degres.\"",
        "    evidence_hash: sha256:demo-hit-7",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-memory?turn=demo-memory-assistant-margin\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-memory?around=demo-memory-assistant-margin\"",
        "  - rank: 8",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-memory\"",
        "    session_title: \"Patisserie Budget\"",
        "    turn_id: \"demo-memory-user-confirm\"",
        "    role: user",
        "    created_at: \"2026-06-15T11:05:48.000Z\"",
        "    matched_field: message_text",
        "    score: 5.100",
        "    snippet: \"Confirme moi juste: croissant budget 24 euros et four 180, c'est bien la note finale.\"",
        "    evidence_hash: sha256:demo-hit-8",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-memory?turn=demo-memory-user-confirm\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-memory?around=demo-memory-user-confirm\"",
        "  - rank: 9",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-menu-anniversaire\"",
        "    session_title: \"Menu Anniversaire\"",
        "    turn_id: \"demo-menu-assistant-recap\"",
        "    role: assistant",
        "    created_at: \"2026-06-12T17:02:18.000Z\"",
        "    matched_field: message_text",
        "    score: 4.900",
        "    snippet: \"Recap menu: croissants sales, plaque au four 180 degres, budget global encore a verifier.\"",
        "    evidence_hash: sha256:demo-hit-9",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?turn=demo-menu-assistant-recap\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-menu-anniversaire?around=demo-menu-assistant-recap\"",
        "  - rank: 10",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-notes-cuisson\"",
        "    session_title: \"Notes Cuisson Ete\"",
        "    turn_id: \"demo-notes-user-croissant\"",
        "    role: user",
        "    created_at: \"2026-06-09T11:29:36.000Z\"",
        "    matched_field: message_text",
        "    score: 4.500",
        "    snippet: \"Pour les croissants du matin, note four 180 degres et surveiller la couleur apres dix minutes.\"",
        "    evidence_hash: sha256:demo-hit-10",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-notes-cuisson?turn=demo-notes-user-croissant\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-notes-cuisson?around=demo-notes-user-croissant\"",
        "  - rank: 11",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-organisation-brunch\"",
        "    session_title: \"Organisation Brunch\"",
        "    turn_id: \"demo-brunch-assistant-budget\"",
        "    role: assistant",
        "    created_at: \"2026-06-07T08:14:05.000Z\"",
        "    matched_field: message_text",
        "    score: 4.100",
        "    snippet: \"Organisation brunch: budget viennoiseries 42 euros, dont croissants et cuisson possible au four a 180.\"",
        "    evidence_hash: sha256:demo-hit-11",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-organisation-brunch?turn=demo-brunch-assistant-budget\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-organisation-brunch?around=demo-brunch-assistant-budget\"",
        "  - rank: 12",
        "    source_type: session_message",
        "    session_id: \"searcharchive-loop-demo-organisation-brunch\"",
        "    session_title: \"Organisation Brunch\"",
        "    turn_id: \"demo-brunch-user-final\"",
        "    role: user",
        "    created_at: \"2026-06-07T08:33:27.000Z\"",
        "    matched_field: message_text",
        "    score: 3.900",
        "    snippet: \"Garde la note finale du brunch: croissants, four a 180, et budget a ne pas depasser.\"",
        "    evidence_hash: sha256:demo-hit-12",
        "    open_ref: \"forge://archive/session/searcharchive-loop-demo-organisation-brunch?turn=demo-brunch-user-final\"",
        "    fetch_more_ref: \"forge://archive/session/searcharchive-loop-demo-organisation-brunch?around=demo-brunch-user-final\""
      ].join("\n"),
    ...
    },
    {
      ...
      role: "assistant",
      text: "J'ai retrouvé douze morceaux utiles, regroupés par session. La session Patisserie Budget contient les passages principaux sur le budget croissant et le four à 180 degrés; les autres sessions confirment des notes proches sur la cuisson et le budget.",
