...
function webExplorerCodeActInstructions(moduleId = ""): string {
  ...
  return [
    ...
    `Si l'utilisateur demande une carte, Google Earth, une exploration geographique ou des coordonnees, ecris une phrase naturelle puis active ${BRAIN_MAPS_COMMAND}. Ne lis jamais la position de l'ordinateur sans permission explicite.`,
