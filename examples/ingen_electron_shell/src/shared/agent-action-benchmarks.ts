...
export const AGENT_ACTION_BENCHMARK_SUITE: readonly AgentActionBenchmarkCase[] = [
  ...
  },
  {
    ...
    surface: "browser",
    userGoal: "download a file from a web page and verify it landed",
    primaryActionId: "browser.download",
    fallbackActionIds: ["browser.inspect_url", "shell.full"],
  ...
  },
  {
    ...
    primaryActionId: "planned:cloud.cli_write",
    fallbackActionIds: ["shell.full", "human_presence"],
    eventCommand: "/agent_shell_",
    eventLabel: "confirmed shell command executed",
