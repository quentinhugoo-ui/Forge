...
const BRAIN_COMMAND_DESCRIPTION_PAIRS: &[(&str, &str)] = &[
    ...
    ("BRAIN_GOOGLEPLACE_COMMAND", "BRAIN_GOOGLEPLACE_COMMAND_DESCRIPTION"),
    ...
    ("BRAIN_LOCAL_ACTIONS_COMMAND", "BRAIN_LOCAL_ACTIONS_COMMAND_DESCRIPTION"),
    ...
    ("BRAIN_CHART_COMMAND", "BRAIN_CHART_COMMAND_DESCRIPTION"),
    ("BRAIN_EDIT_CHART_COMMAND", "BRAIN_EDIT_CHART_COMMAND_DESCRIPTION"),
    ("BRAIN_MARKET_ORDER_COMMAND", "BRAIN_MARKET_ORDER_COMMAND_DESCRIPTION"),
];
...
const TRANSCRIPT_MESSAGE: InterfaceSpec = InterfaceSpec {
    ...
    fields: &[
        ...
        FieldSpec { name: "archiveFocusSnippet", ts_type: "string", optional: true },
        FieldSpec { name: "proofHash", ts_type: "string", optional: false },
    ],
};
...
const PARALLEL_CHAT_LANE: InterfaceSpec = InterfaceSpec {
    ...
    fields: &[
        ...
        FieldSpec { name: "sessionId", ts_type: "string", optional: false },
        FieldSpec { name: "sessionTitle", ts_type: "string", optional: false },
