...
describe("Banger native viewport contract", () => {
  ...
  it("paints the Maps sphere from the Banger preview frame returned by IPC", () => {
    ...
    expect(stylesSource).toContain("width: min(95.957114vw, 119.119176vh, 1257.916px)");
    expect(stylesSource).toContain("height: min(95.957114vw, 119.119176vh, 1257.916px)");
    ...
    expect(stylesSource).toContain("width: min(100%, 1257.916px)");
