...
describe("Banger native viewport contract", () => {
  ...
  it("paints the Maps sphere from the Banger preview frame returned by IPC", () => {
    ...
    expect(stylesSource).toContain("width: min(79.3034vw, 98.4456vh, 1039.6px)");
    expect(stylesSource).toContain("height: min(79.3034vw, 98.4456vh, 1039.6px)");
    ...
    expect(stylesSource).toContain("width: min(100%, 1039.6px)");
