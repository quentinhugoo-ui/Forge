...
describe("Banger native viewport contract", () => {
  ...
  it("paints the Maps sphere from the Banger preview frame returned by IPC", () => {
    ...
    expect(stylesSource).toContain("width: min(70.18vw, 87.12vh, 920px)");
    expect(stylesSource).toContain("height: min(70.18vw, 87.12vh, 920px)");
    ...
    expect(stylesSource).toContain("width: min(100%, 920px)");
