...
const shellClickActions = Object.freeze([
  ...
  ["#providerLauncherOpenRouter", "provider-launch-openrouter"],
  ...
  ["#openRouterProviderConnect", "provider-openrouter-connect"],
  ["#openRouterProviderRefresh", "provider-openrouter-refresh"],
  ["#openRouterProviderDisconnect", "provider-openrouter-disconnect"],
