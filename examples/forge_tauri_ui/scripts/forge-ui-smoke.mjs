...
const realEstateKasmSimulator = read("scripts/real-estate-kasm-simulator.mjs");
...
const realEstateToolCellRunner = read("scripts/real-estate-tool-cell-runner.mjs");
...
expect("banger shader/math catalog lives outside banger.js", bangerCatalogTs.includes("ForgeBangerCatalog") && bangerCatalogTs.includes("VS_MESH") && bangerCatalogTs.includes("export const M4") && bangerCatalogTs.includes("export function makeCube") && bangerCatalogTs.includes("export function makeGrid") && bangerBundleJs.includes("ForgeBangerCatalog") && bangerJs.includes("window.ForgeBangerCatalog") && !bangerJs.includes("const VS_MESH = `") && !bangerJs.includes("const M4 = {") && !bangerJs.includes("function makeCube") && !bangerJs.includes("function makeGrid"));
...
expect("real estate KASM simulator invokes the Rust massive compute lab", realEstateKasmSimulator.includes("kasm_rust_compute.json") && realEstateKasmSimulator.includes("cargo") && realEstateKasmSimulator.includes("lab_runner_immo") && realEstateKasmSimulator.includes("--seeds") && realEstateKasmSimulator.includes("workItems") && realEstateKasmSimulator.includes("ranked_actions.json"));
...
expect("real estate tool cell runner validates manifests and runs KASM dataflow queries", realEstateToolCellRunner.includes("validateCells") && realEstateToolCellRunner.includes("ToolCell { manifest, inputSchema, outputSchema, permissions, denied, proofHash }") && realEstateToolCellRunner.includes("living_dataflow_graph.json") && realEstateToolCellRunner.includes("tool_cell_outputs") && realEstateToolCellRunner.includes("manifestHash") && realEstateToolCellRunner.includes("rankedActions"));
...
expect("real estate source pipeline orchestrates proofed stages", realEstateSourcePipeline.includes("pipeline_run.json") && realEstateSourcePipeline.includes("runStep(\"audit\"") && realEstateSourcePipeline.includes("runStep(\"resolve\"") && realEstateSourcePipeline.includes("runStep(\"intel\"") && realEstateSourcePipeline.includes("runStep(\"seeds\"") && realEstateSourcePipeline.includes("runStep(\"simulate\"") && realEstateSourcePipeline.includes("runStep(\"memory\"") && realEstateSourcePipeline.includes("runStep(\"dataflow\"") && realEstateSourcePipeline.includes("runStep(\"toolcells\"") && realEstateSourcePipeline.includes("runStep(\"evidence\"") && realEstateSourcePipeline.includes("livingDataflowGraph") && realEstateSourcePipeline.includes("toolCellOutputs") && realEstateSourcePipeline.includes("evidenceMemoryFacts") && realEstateSourcePipeline.includes("proofHash") && realEstateSourcePipeline.includes("--adapters"));
